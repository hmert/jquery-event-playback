...
(function($){
  ...
  EventPlayer.prototype = {
    playFrame : function(frame) {
      ...
      switch (frame.type) {
        case 'click': this.cursor.addClass('clicking'); break
        default: this.cursor.removeClass('clicking')
      }
    },
    ...
    displayCursor : function() {
      this.cursor = $('<div id="event-playback-cursor" style="z-index: 90; position: absolute; display: none;">([o.o])</div>')
