...
(function($){
  ...
  // TODO: pack or deflate with table for xpath's
  ...
  EventRecorder.prototype = {
    ...
    export : function() {
      // TODO: support when not built with toSource()
      if (this.running) throw 'EventRecorder: cannot export while running'
      return { frames : this.frames }.toSource()
    },
  ...
  EventPlayer.prototype = {
    ...
    getElementByXPath : function(path) {
      // TODO: fix BODY[n]
      // TODO: Safari support
      result = document.evaluate(path.replace(/BODY\[\d+\]/, 'BODY'), document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null)
