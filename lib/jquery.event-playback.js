...
(function($){
  ...
  EventRecorder.prototype = {
    ...
    start : function() {
      ...
      setTimeout(function(){
        self.running = true
        self.startRecordingMouseEvents()
  ...
  EventPlayer.prototype = {
    ...
    playFrame : function(frame) {
      ...
      switch (frame.type) {
        ...
        case 'mousemove':
          this.trigger('mouseover', frame.target) 
          if (this.lastPath != frame.xpath) 
            this.trigger('mouseout', $(this.getElementByXPath(this.lastPath)))
          break
